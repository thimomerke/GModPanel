                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><span class="label label-<?php echo $Timer > 1.0 ? 'danger' : 'success'; ?>"><?php echo "Ping: " . $Timer; ?>s</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>Spieler</td>
                                <td>
                                    <?php echo $Info[ 'Players'] . ' / ' . $Info[ 'MaxPlayers']; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Hat Passwort?</td>
                                <td>
                                    <?php if ($Info[ 'Password']==1 ) { echo "Ja"; } else { echo "Nein"; } ?>
                                </td>
                            </tr>
                            <?php else: ?>
                            <tr>
